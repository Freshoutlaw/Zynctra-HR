import { n as __commonJSMin } from "./react-BJo0xem_.js";
	...
	(function() {
		...
		o.prototype = {
			...
			play: function(e, o) {
				...
				if (t._webAudio) {
					var v = function() {
						...
						m.gain.setValueAtTime(e, n.ctx.currentTime), d._playStart = n.ctx.currentTime, void 0 === m.bufferSource.start ? d._loop ? m.bufferSource.noteGrainOn(0, _, 86400) : m.bufferSource.noteGrainOn(0, _, s) : d._loop ? m.bufferSource.start(0, _, 86400) : m.bufferSource.start(0, _, s), l !== Infinity && (t._endTimers[d._id] = setTimeout(t._ended.bind(t, d), l)), o || setTimeout(function() {
			...
			stop: function(e, n) {
				...
				for (var t = o._getSoundIds(e), r = 0; r < t.length; r++) {
					...
					a && (a._seek = a._start || 0, a._rateSeek = 0, a._paused = !0, a._ended = !0, o._stopFade(t[r]), a._node && (o._webAudio ? a._node.bufferSource && (void 0 === a._node.bufferSource.stop ? a._node.bufferSource.noteOff(0) : a._node.bufferSource.stop(0), o._cleanBuffer(a._node)) : isNaN(a._node.duration) && a._node.duration !== Infinity || (a._node.currentTime = a._start || 0, a._node.pause(), a._node.duration === Infinity && o._clearSound(a._node))), n || o._emit("stop", a._id));
				}
				return o;
			},
			mute: function(e, o) {
			...
			volume: function() {
				...
				if (1 === r.length || 2 === r.length && void 0 === r[1]) t._getSoundIds().indexOf(r[0]) >= 0 ? o = parseInt(r[0], 10) : e = parseFloat(r[0]);
			...
			rate: function() {
				...
				else if (1 === r.length) t._getSoundIds().indexOf(r[0]) >= 0 ? o = parseInt(r[0], 10) : e = parseFloat(r[0]);
				...
				for (var i = 0; i < o.length; i++) if (d = t._soundById(o[i])) {
					...
					var _ = t.seek(o[i]), l = 1e3 * ((t._sprite[d._sprite][0] + t._sprite[d._sprite][1]) / 1e3 - _) / Math.abs(d._rate);
			...
			seek: function() {
				...
				else if (1 === r.length) t._getSoundIds().indexOf(r[0]) >= 0 ? o = parseInt(r[0], 10) : t._sounds.length && (o = t._sounds[0]._id, e = parseFloat(r[0]));
				else 2 === r.length && (e = parseFloat(r[0]), o = parseInt(r[1], 10));
		...
		t.prototype = {
			...
			_endListener: function() {
				...
				n._duration === Infinity && (n._duration = Math.ceil(10 * e._node.duration) / 10, n._sprite.__default[1] === Infinity && (n._sprite.__default[1] = 1e3 * n._duration), n._ended(e)), e._node.removeEventListener("ended", e._endFn, !1);
			}
		};
		var r = {}, a = function(e) {
			var n = e._src;
...
//# sourceMappingURL=howler-C_BpC6d5.js.map