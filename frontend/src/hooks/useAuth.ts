...
// // Re-export the canonical useAuth from AuthContext
// export { useAuth } from '../context/AuthContext';
// export { useAuth as default } from '../context/AuthContext';

// // Also re-export all security utilities from AuthContext (single source of truth)
// export {
 ...
 *
 * Security note: All token operations are encapsulated in sessionStorage
 * and never exposed to React state to prevent XSS exfiltration.
 */
...
export type { AuthContextType, User, RegisterData } from '../types/auth.types';