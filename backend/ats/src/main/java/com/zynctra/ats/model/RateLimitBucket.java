 ...
 *
 * <p>Designed for per-tenant or per-user isolation. Each bucket tracks:
 * <ul>
 *   <li>Available tokens (refilled over time)</li>
 *   <li>Last refill timestamp</li>
 *   <li>Total requests and blocked requests (for abuse detection)</li>
 * </ul>
 * </p>
 * 
 * <p>Thread-safe via {@link AtomicLong} for token tracking.</p>
 */
@Getter
