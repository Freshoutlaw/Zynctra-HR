 ...
 *
 * <p>This type prevents accidental use of raw user input in queries
 * by requiring explicit construction through the factory method.</p>
 *
 * <p>Escape character is {@code !} (exclamation mark).</p>
 */
@Getter
